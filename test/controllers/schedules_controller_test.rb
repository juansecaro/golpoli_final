...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { date_ref: @schedule.date_ref, pitch_id: @schedule.pitch_id } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { date_ref: @schedule.date_ref, pitch_id: @schedule.pitch_id } }
